...
from cumulusci.core.bitbucket import get_version_id_from_commit
from cumulusci.tasks.bitbucket.base import BaseBitbucketTask
from cumulusci.tasks.salesforce.BaseSalesforceApiTask import BaseSalesforceApiTask


class GetPackageDataFromCommitStatus(BaseBitbucketTask, BaseSalesforceApiTask):
    task_options = {
        "context": {
    ...
    def _run_task(self):
        ...
        self.logger.debug(f"Version id is currently set to {version_id}")
